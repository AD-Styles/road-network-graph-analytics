...
| **Section 4** | **그래프 기본 분석** | 노드 1,225개 / 엣지 2,622개 / 평균 차수 4.28 확인. 차수 분포·도로 형태·속도 제한 시각화<br><br><img src="plots/01_data_overview.png" width="100%"><br><br>💡 **결과 해석:** 대시보드를 통해 8종의 도로 유형별 속도 제한과 전체 연결 상태를 한눈에 파악. 대부분의 노드가 4개의 연결(차수 4)을 가지는 전형적인 격자형 도로망의 기초 통계를 보여줌. |
